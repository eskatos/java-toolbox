 ...
 */
package org.codeartisans.java.toolbox.resources;
...
public class PropertiesWriter
{
    ...
    {
        NullArgumentException.ensureNotNull("Output stream", outputStream);
        NullArgumentException.ensureNotNull("Separator", separator);
